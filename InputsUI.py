...
layout = [
    [sg.Text("Find Your Table", justification="center", size=(30,1), font=("Helvetica", 25))],
    [sg.CalendarButton("Date", close_when_date_chosen=True,  target='-IN-', no_titlebar=False, format='%b %d, %Y' ), sg.Input(key='-IN-', size=(15,1)),],
    [sg.Text("Time", size=(15,1)), sg.Combo(times)],
    [sg.Text("Party Size", size=(15,1)), sg.Combo(party_sizes)],
    [sg.Text("Neighborhood", size =(15, 1)), sg.InputText(size=(15,1))],
    [sg.Exit()]
    ]
